...
On github: https://github.com/JeffHoogland/pypair/blob/master/pypair.py
'''
                ...
                for player in bracketGraph.nodes():
                    for opponent in bracketGraph.nodes():
                        if opponent not in self.playersDict[player]["Opponents"] and player != opponent:
                            ...
                            if self.playersDict[player]["Points"] > int(points.split('_')[0]) or self.playersDict[opponent]["Points"] > int(
                                    points.split('_')[0]):
                                wgt = 10
                            # Create edge
